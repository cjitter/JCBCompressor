...
- Implementación sistema de bypass compensado (portado de JCBTransient)
- v1.0.0-alpha.1 validada con éxito en **AUVAL**, **pluginval**, **VST3 validator** y **AAX validator**.
