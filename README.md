...
- **Compresor de rango dinámico** con controles de threshold, ratio, attack, release y knee.
- **Control de entrada y salida** (trim y makeup) ±12 dB, con opción de auto gain (hasta 70%).
- **Procesamiento sidechain** interno y externo con filtros HPF/LPF variables (20 Hz – 20 kHz), en 2º o 4º orden.
- **Tres modos de detección**: sharp (sliding RMS), RMS exponencial y RMS lento, con interpolación continua.
- **Compresión con softknee** ajustable de 0 a 30 dB.
- **Paralelo integrado**: mezcla Dry/Wet y compresión paralela mediante suma de señal seca y comprimida.
- **Softclip de salida** asimétrico, aplicado tras la compresión.
- **Modo Delta activable**, para escuchar únicamente la diferencia entre señal procesada y original.
- **Procesamiento estéreo**, con opción de estéreo link.
- **Visualización gráfica** en tiempo real: forma de onda, medidores y reducción de ganancia.
- **Gestión de presets** completa (fábrica y usuario).
- **Bypass interno** con transición suave.
- **Modo lookahead** de 0 a 10 ms, con compensación exacta de latencia en todos los hosts.
- **Thread safety mejorada**, con actualizaciones de interfaz seguras y verificado en pluginval.
...
*© 2025 Juan Carlos Blancas – JCBCompressor v1.0.0-alpha.2*
